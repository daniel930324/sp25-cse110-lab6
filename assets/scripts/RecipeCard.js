...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let shadowEl = this.attachShadow({mode: 'open'}); // A1. TODO - Attach the shadow DOM to this Web Component (leave the mode open)
		let article = document.createElement('article'); // A2. TODO - Create an <article> element - This will hold our markup once our data is set
		let style = document.createElement('style'); // A3. TODO - Create a style element - This will hold all of the styles for the Web Component
